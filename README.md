...
![Claude AI](https://raw.githubusercontent.com/quantiota/AI-Agent-Farm/refs/heads/master/claude-open-source.png)
...
### Dockerization
The four applications used in this project (Visual Studio Code, QuestDB, Grafana, and an AI Agent) are Dockerized to simplify deployment and management. The Dockerfiles and docker-compose configurations live in the [AI Agent Host](https://github.com/quantiota/AI-Agent-Host) and [AI Agent Lab](https://github.com/quantiota/AI-Agent-Lab) repositories, with build and run instructions in their documentation. By Dockerizing the applications, it is possible to create a self-contained environment that can be easily moved between systems or replicated on multiple machines. This can simplify deployment and ensure consistency across different environments.
...
[Structured Knowledge Accumulation](https://github.com/quantiota/AI-Agent-Farm/tree/master/ska-framework)
